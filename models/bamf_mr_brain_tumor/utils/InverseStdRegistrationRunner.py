...
class InverseStdRegistrationRunner(Module):
    ...
    @IO.Outputs('out_datas', path='[filename].nii.gz', dtype='nifti:task=std_inverse', data='in_mat_datas', bundle='inverse_atlas_registration', auto_increment=True, the="converted data")
