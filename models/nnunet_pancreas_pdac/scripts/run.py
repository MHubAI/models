"""
-------------------------------------------------
MHub - run the NNUnet pancreas segmentation
       pipeline
-------------------------------------------------
...
# config
config = Config('/app/models/nnunet_pancreas_pdac/config/config.yml')
...
organizer.setTarget(DataType(FileType.NIFTI, SEG), "/app/data/output_data/[i:sid]/pancreas.nii.gz")
