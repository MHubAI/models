...
class CasustRunner(ModelRunner):
    ...
    @IO.Output('vl', 'Ventricle_L.nrrd', 'nrrd:mod=seg:roi=Ventricle_L', the='predicted segmentation of the left ventricle')
    @IO.Output('vr', 'Ventricle_R.nrrd', 'nrrd:mod=seg:roi=Ventricle_R', the='predicted segmentation of the right ventricle')
    @IO.Output('lad', 'Coronary_LAD.nrrd', 'nrrd:mod=seg:roi=Coronary_LAD', the='predicted segmentation of the left anterior descending coronary artery')
    @IO.Output('rca', 'Coronary_Atery_R.nrrd', 'nrrd:mod=seg:roi=Coronary_Atery_R', the='predicted segmentation of the right coronary artery')
    @IO.Output('cflx', 'Coronary_Atery_CFLX.nrrd', 'nrrd:mod=seg:roi=Coronary_Atery_CFLX', the='predicted segmentation of the circumflex branch of the coronary artery')
