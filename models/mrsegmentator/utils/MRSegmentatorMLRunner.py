...
mapping = {
    ...
    'pancreas': 'PANCREAS',
    'right_adrenal_gland': 'RIGHT_ADRENAL_GLAND',
    'left_adrenal_gland': 'LEFT_ADRENAL_GLAND',
    'left_lung': 'LEFT_LUNG',
...
#NOte: Background, SPINE still needs to be implemented
...
class MRSegmentatorMLRunner(Module):
    ...
    def task(self, instance: Instance, in_data: InstanceData, out_data: InstanceData) -> None:
        ...
        bash_command += ["-outdir", out_data.abspath]
